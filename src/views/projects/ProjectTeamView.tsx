    ...
    return (
      <>
        ...
        <p className="text-2xl font-light text-gray-500 mt-5">
          Aquí puedes administrar los colaboradores de tu proyecto.
        </p>
        <nav className="my-5 flex gap-3 overflow-x-scroll">
          ...
          <Link
            ...
            className="w-full sm:w-auto bg-fuchsia-500 hover:bg-fuchsia-600 px-2  sm:px-10 py-3 text-white text-xl font-bold cursor-pointer transition-colors text-center"
          >
            Volver al Proyecto
          </Link>
        </nav>
